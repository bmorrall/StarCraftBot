...
import sc2
from sc2.constants import COMMANDCENTER, ORBITALCOMMAND, SUPPLYDEPOT, BARRACKS, REFINERY
...
class BuildingConstructor:
    def __init__(self, game: sc2.BotAI) -> None:
        ...
        self.orbital_command_builder = OrbitalCommandBuilder(game)
    ...
    async def on_step(self, iteration):
        ...
        await self.orbital_command_builder.on_step(iteration)
    ...
    def set_orbital_command_target(self, orbital_command_target: int):
        self.orbital_command_builder.target = orbital_command_target
